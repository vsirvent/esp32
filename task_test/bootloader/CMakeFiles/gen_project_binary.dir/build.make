...
.bin_timestamp: bootloader.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/vsirvent/src/mia/task_test/bootloader/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating binary image from built executable"
	python /home/vsirvent/src/esp-idf/components/esptool_py/esptool/esptool.py --chip esp32 elf2image --flash_mode dio --flash_freq 40m --flash_size 2MB -o /home/vsirvent/src/mia/task_test/bootloader/bootloader.bin /home/vsirvent/src/mia/task_test/bootloader/bootloader.elf
	/usr/bin/cmake -E echo "Generated /home/vsirvent/src/mia/task_test/bootloader/bootloader.bin"
	/usr/bin/cmake -E md5sum /home/vsirvent/src/mia/task_test/bootloader/bootloader.bin > /home/vsirvent/src/mia/task_test/bootloader/.bin_timestamp
